...
$tabs = [
    [
        "title" => "Padres / Parents",
        "members" => [
            [
                "name" => "Victoria",
                "rol-en" => "Mother of the Bride",
                "rol-es" => "Madre de la Novia",
                ...
                "image" => "/wp-content/themes/theme-anamariaeduardo/img/padrinos/padres/victoria.webp"
            ],
            [
                "name" => "Jaime",
    ...
    [
        ...
        "members" => [
            ...
            [
                ...
                "image" => "/wp-content/themes/theme-anamariaeduardo/img/padrinos/pajecitos/mila.webp"
            ],
            [
                "name" => "Erika",
                "rol-en" => "Flower Girl",
                "rol-es" => "Pajecita",
                "content-en" => "Erika is our precious little ball of energy! She is sweet, fun, and always ready to join the party. Erika is the bride's honorary brother's youngest daughter. The bride recalls climbing trees and sharing endless adventures with Erika's father and it is her absolute joy to have his baby girl by her side as one of her flower girls on this special day. ",
                "content-es" => "¡Erika es nuestra pequeña bola de energía! Es dulce, divertida y siempre está lista para unirse a la fiesta. Erika es la hija menor del hermano honorario de la novia. La novia recuerda trepar árboles y compartir interminables aventuras con el padre de Erika y es una alegría absoluta tener a su pequeña junto a ella como una de sus pajecitas en este día especial.",
    ...
    [
        ...
        "members" => [
            ...
            [
                "name" => "Gonzalo - Padrino de Matrimonio",
            ...
            [
                "name" => "Ilse - Madrina de Matrimonio ",
            ...
            [
                "name" => "Vincent- Ring Security",
                "rol-en" => "Bridesmaid",
                "rol-es" => "DaGodmotherma",
        ...
        <div class="tabs-container">
            <ul class="tabs">
                <?php foreach ($tabs as $key => $tab) { ?>
                    <li class="tab-link <?php echo $key == 0 ? 'active' : ''; ?>" data-tab="tab<?php echo $key; ?>"><?php echo $tab['title']?></li>
                <?php } ?>
            </ul>
                        ...
                        <?php if (!empty($tab['members'])) { ?>
                            <?php foreach ($tab['members'] as $index => $member) { ?>
                                <div class="member-name" data-tab="tab<?php echo $key; ?>-member<?php echo $index; ?>">
                                    <img class="member-img" src="<?php echo $member['image']; ?>" alt="">
                                ...
                                <div id="tab<?php echo $key; ?>-member<?php echo $index; ?>" class="member-content <?php if($index === 0) { echo 'active'; } ?>">
                                    ...
                                    <p class="text--11">
                                        <?php echo $member['content-en']; ?>
                                    </p>
                                    <br>
                                    <p class="text--11">
                                        <?php echo $member['content-es']; ?>
                                    </p>
                                </div>
                            <?php } ?>
                        <?php } else { ?>
                            <div>No members in this category.</div>
                        <?php } ?>
                    </div>
                </div>
            <?php } ?>
...
document.addEventListener("DOMContentLoaded", function() {
    // Función para activar el primer contenido de cada tab al cargar la página
    ...
    // Función para manejar el clic en los nombres de los miembros
    ...
    // Inicialmente ocultar todos los contenidos de miembros
    const allContents = document.querySelectorAll(".member-content");
    allContents.forEach(content => content.classList.remove("active"));

    // Activar el primer contenido de cada tab al cargar la página
