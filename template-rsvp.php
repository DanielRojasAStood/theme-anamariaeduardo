        ...
        <div class="box text-center">
            ...
            <div class="sectionRSVP__faqs">
                ...
                <?php foreach ($faqs as $key => $faq) { ?>
                    <div>
                        <?php if ($key % 2 == 0) { ?>
                            <button type="button" class="accordion-link text--14" data-tab="question<?php echo $key; ?>"><?php echo ($key / 2) + 1; ?>. 
                        ...
                        <?php } else { ?>
                            <button type="button" class="accordion-link text--14" data-tab="question<?php echo $key; ?>">
                                <?php echo $faq['question']; ?>
                                <?php 
                                    $icon_name = 'icon-arrow';
                                    get_template_part('template-parts/content', 'icono');
