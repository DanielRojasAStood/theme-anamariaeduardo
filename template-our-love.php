...
<main>
  <section class="sectionOurLove">
    ...
    <div class="box">
      <h2 class="text--22 text-center" style="height: 15px">OUR LOVE</h2>
      <h2 class="text--56 pb-7 text-center pb-28">Nuestra Historia</h2>

      <div class="grid">
        <div class="sectionOurLove__img">
          <?php foreach ($love as $key => $item) { ?>
              <img src="<?php echo IMG_BASE . "history/" . $item['image']; ?>" id="image-<?php echo $item['year']; ?>" style="display: none;">
            <?php } ?>
        </div>
          ...
          <div class="sectionOurLove__content">
            <?php foreach ($love as $key => $item) { ?>
              <div class="sectionOurLove__year" id="year-<?php echo $item['year']; ?>">
                ...
                <p class="text--11"><?php echo $item['text-es']; ?></p>
              </div>
            <?php } ?>
          </div>
        </div>
      ...
      <a href="#" class="next-button">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="19" viewBox="0 0 35 19" fill="none">
          <path d="M34 1L17.5 17.5L1 0.999997" stroke="black"/>
        </svg>
      </a>
    </div>
  </section>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const sections = document.querySelectorAll(".sectionOurLove__year");
    const scrollContainer = document.querySelector(".sectionOurLove__scroll");
    const images = document.querySelectorAll(".sectionOurLove__img img");
    let currentIndex = 0;
    ...
    nextButton.addEventListener("click", function(event) {
      ...
      if (isAnimating) return; // Evitar múltiples clics mientras se está animando
      isAnimating = true;

      currentIndex++;
      if (currentIndex < sections.length) {
        const targetElement = sections[currentIndex];
    ...
    function scrollToElement(element) {
      ...
      const targetOffset = elementTop - containerTop + scrollContainer.scrollTop;
      ...
      setTimeout(() => {
        isAnimating = false;
      }, 800); // Ajustar este valor según la duración de tu animación CSS
    }
